...
public class HomePageUI {
	...
	public static final String PAGINATION_ACTIVED_BY_NUMBER="xpath=//li[@class='qgrd-pagination-page']/a[@class='qgrd-pagination-page-link active' and text()='%s']";
	...
	public static final String COULUMN_INDEX_BY_NAME="xpath=//tr/td[text()='%s']/preceding-sibling::td";
