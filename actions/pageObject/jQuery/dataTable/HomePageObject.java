...
public class HomePageObject extends BasePage {
	...
	public boolean isPageNumberActivated(String pageNumber) {
		waitForElementVisible(driver, HomePageUI.PAGINATION_ACTIVED_BY_NUMBER, pageNumber);
		return isElementDisplay(driver,  HomePageUI.PAGINATION_ACTIVED_BY_NUMBER, pageNumber);
	}
	...
	public void enterToTextboxByColumNameAtRowNumber(String columnName, String rowNumber, String valueToEnter) {
		int columnIndex= getElementSize(driver, HomePageUI.COULUMN_INDEX_BY_NAME,columnName)+1;
	...
	public void clickToButtonIconByRowNumber(String rowNumber, String iconName) {
